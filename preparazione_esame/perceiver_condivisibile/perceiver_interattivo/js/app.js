...
const RAIL_DATA = {
  ...
  45: { stage: 0, idea: "Perceiver: le 7 run CIFAR-10 una per una (PE −10.68, permutazione +8.43, sharing +5.36) e le 3 su ModelNet40 (84.24%, −1.5 dal paper)." },
  46: { stage: 0, idea: "Perceiver IO: decoder a query (+8.51 su exp1), MLM byte 82.20%, GLUE ~63% vs 81% — letto contro il <em>livello banale</em> di ogni task." },
