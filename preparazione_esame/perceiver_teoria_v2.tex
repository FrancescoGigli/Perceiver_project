...
% =====================================================================
%  "Sei qui" sull'immagine dell'architettura --- riquadro arancione
%  \seiqui{x1}{y1}{x2}{y2}{label}   (coords normalizzate 0..1)
% =====================================================================
\definecolor{seiquicolor}{HTML}{e65100}
\newcommand{\seiqui}[5]{%
\begin{center}
\begin{tikzpicture}
  \node[anchor=south west, inner sep=0] (img)
    {\includegraphics[width=0.58\textwidth]{./appunti_images/media/image47.png}};
  \begin{scope}[x={(img.south east)}, y={(img.north west)}]
    \draw[seiquicolor, line width=1.6pt, rounded corners=3pt]
      (#1, #2) rectangle (#3, #4);
  \end{scope}
\end{tikzpicture}\\[1pt]
{\small\color{seiquicolor}\textbf{Sei qui:} \emph{#5}}
\end{center}}
...
\hypersetup{
  ...
  urlcolor=linkblue,
  pdftitle={Perceiver --- Sintesi Teorica (v2)}}

\title{\textbf{\color{seccolor} Perceiver --- Sintesi Teorica}\,\textnormal{\Large(v2)}\\[4pt]
  \large Versione con ``sei qui'' sull'architettura}
\author{}
\date{}
...
\seiqui{0.05}{0.18}{0.14}{0.40}{Byte array (input)}
...
\seiqui{0.05}{0.18}{0.14}{0.40}{Byte array $+$ Fourier PE}
...
\seiqui{0.05}{0.55}{0.13}{0.82}{Latent array}
...
\seiqui{0.19}{0.34}{0.27}{0.72}{Cross-Attention}
...
\seiqui{0.33}{0.46}{0.42}{0.76}{Latent Transformer}
...
\seiqui{0.45}{0.32}{0.69}{0.78}{Iterazioni $\times T$ (weight sharing)}
...
\seiqui{0.85}{0.50}{0.97}{0.74}{Avg $+$ Project $\to$ Logits}
