...
const RAIL_DATA = {
  ...
  44: { stage: 0, idea: "Esperimenti: quali modalità (immagini, 3D, testo — non audio/video), i dataset, e la <strong>banda di rumore di 2,78 punti</strong> da 3 run identiche tranne il seed." },
  45: { stage: 0, idea: "Perceiver: le 24 run CIFAR-10 una per una, ciascuna col verdetto sulla banda di rumore di 2,78 punti (12 su 24 sono concludenti, 10 misurando dalla media dei tre seed), e le 3 su ModelNet40 (87,36%, <em>sopra</em> il paper anche all'ultima epoca)." },
  46: { stage: 0, idea: "Perceiver IO: il decoder a query. Su immagini non cambia nulla (71,79% contro 71,63%); sul testo l'MLM a byte fa 86,68% (una tabella dei vicini fa 42,96%), GLUE 71,13 di media e il multitask 74,05." },
