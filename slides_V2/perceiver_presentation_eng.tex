...
\begin{frame}[shrink=5]{CIFAR-10: Fixed-Permutation Test}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        \item Permuted vs natural order: $+$8.43pp --- the shuffled task stays fully learnable
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item Read it as \emph{invariance}, not a gain from shuffling: order carries no information, only the PE does
      \end{itemize}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.39\textwidth}
      ...
      \begin{itemize}
        ...
        \item CoLA acc.\ $\approx$ majority baseline ($\sim$69\%; official metric is MCC)
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=5]{Comprehensive Results Summary}
  \begin{table}
    ...
    \begin{tabular}{llccl}
      ...
      \midrule
      Images (CIFAR-10) & Perceiver & 78.12\% & $>$90\%$^{\dagger}$ & 7 ablations \\
  ...
  {\scriptsize $^{\dagger}$ Strong ViT/CNN baselines on CIFAR-10; the original Perceiver paper does not benchmark CIFAR-10.}
...
\begin{frame}[shrink=10]{Gap vs Original Papers}
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      ...
      Reference is strong ViT/CNN baselines (the Perceiver paper has no CIFAR-10); scale gap: TPU cluster vs single GPU.
    \end{column}
  \end{columns}
...
\begin{frame}{References}
  ...
  \begin{thebibliography}{9}
    ...
    \bibitem{gelu} D.~Hendrycks and K.~Gimpel,
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \begin{enumerate}
        ...
        \item What is the role of GELU?\\
          {\scriptsize $\rightarrow$ Smooth MLP activation; stable gradients, standard in Transformers}
      \end{enumerate}
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{Experiments:}
