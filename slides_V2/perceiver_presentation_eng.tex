...
% â”€â”€ Shared style for inline bar charts (matches the matplotlib PNG charts) â”€â”€â”€â”€
...
\begin{frame}[shrink=12]{CIFAR-10: Fixed-Permutation Test}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{tikzpicture}
        \begin{axis}[
          ...
          \addplot[fill=AccentGreen, forget plot, nodes near coords={}] coordinates {
            (F.Perm,78.12)
          };
        \end{axis}
      \end{tikzpicture}
