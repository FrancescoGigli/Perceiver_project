...
\begin{frame}[shrink=3]{Latent Transformer \& Weight Sharing}
  ...
  \vspace{0.3em}
  \begin{center}
    \includegraphics[width=0.97\textwidth,height=0.35\textheight,keepaspectratio]{perceiver_architecture_overview.png}
  \end{center}

  \vspace{0.05em}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      \textbf{What the figure is showing}
      \begin{itemize}
        \item Cross-attention writes input information into latents.
        \item Latent Transformer blocks refine only $N$ slots.
        \item Dashed bracket: parameters reused across repeats.
      \end{itemize}
    \end{column}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        \item The model adds iterative computation without copying a new full processor each time.
        \item Each repeat sees a new latent state with the same weights:
          $Z_{t+1}=B_{\theta}(Z_t)$.
      \end{itemize}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=3]{Fourier Positional Encoding}
  ...
  \vspace{0.25em}
  \begin{center}
    \includegraphics[width=0.95\textwidth,height=0.50\textheight,keepaspectratio]{fourier_features_encoding.png}
  \end{center}
...
\begin{frame}[shrink=5]{Perceiver Forward Pass: Shape Checkpoints}
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      \textbf{Generic shape checkpoints:}
      \begin{table}
        ...
        \begin{tabular}{lll}
          ...
          \midrule
          $X$ & $M\times C_{\text{tot}}$ & input array \\
...
\begin{frame}[shrink=5]{Original Perceiver Output: Pooling Classifier}
  \begin{columns}[T]
    ...
    \begin{column}{0.47\textwidth}
      ...
      \vspace{0.35em}
      \begin{alertblock}{Decoder distinction}
